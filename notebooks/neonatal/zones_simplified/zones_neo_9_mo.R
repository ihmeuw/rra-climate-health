...
summary_file <- paste0("nnm_9_mo_zone_",zone_no,"_simplified_summary")

results_dir <- "/mnt/team/rapidresponse/pub/population/modeling/climate_malnutrition/neonatal_mortality/results/2025_12_09.01/zones/simplified/mo_9/"
