...
# analysis 1: cutoff data s.t. birth year max 10 years before interview year
...
## set parameters
sample_percent <- 1.0
summary_file <- "subset_100pct_model_10yr_cutoff"
...
# cutoff data for sensitivity analysis 1: 10 years max (120 months)
