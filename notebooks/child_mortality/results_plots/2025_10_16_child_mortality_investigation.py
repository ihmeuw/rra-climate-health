...
df_loc_group = (
    df.groupby(["ihme_loc_id", "year_start"])
    .agg(
        {
            "child_mortality": "mean",
            # "mortality_me_manual": "mean",
...
df_subset = df.query("birth_year >= (int_year_original-10)")
df_loc_group_sub = (
    df_subset.groupby(["ihme_loc_id", "year_start"])
    .agg(
        {
            "child_mortality": "mean",
            # "mortality_me_manual": "mean",
...
px.scatter(df_loc_group_sub, x="child_mortality", y="consumption", color="ihme_loc_id")
