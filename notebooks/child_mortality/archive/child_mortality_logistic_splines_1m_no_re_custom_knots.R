...
## set parameters
summary_file <- "cm_splines_1m_no_re_custom_knots" 
...
sample_percent <- 1000000/nrow(df_model) #
...
print(length(unique(df_sample$indv_id))) #3,164,900
