...
## set parameters
summary_file_root <- "cm_splines_within_" 


data_version <- "/mnt/team/rapidresponse/pub/population/modeling/climate_malnutrition/child_mortality/training_data/2026_04_21.01/data_within_bin.parquet" 
...
setnames(df,old=c("days_over_30C_monthly_within_bin","consumption_pd_within_bin","mean_temperature_monthly_within_bin","total_precipitation_monthly_within_bin"),
