...
general_default_compute_resources_dict = {
    ...
    "stdout": f"/share/temp/slurmoutput/victorvt/output",
...
for measure in ['stunting', 'wasting']:
    model_spec = f'"{measure} ~ (1 | ihme_loc_id) + grid_cell + over_30"'
    for sex_id in [1, 2]:
